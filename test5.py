...
if __name__ == "__main__":
    ...
    norm_file=  r"D:\adavance\Pyqt-main\DetectionModules\Algo1\Similarity_comparison_3D\test_data\daijian\clxz1.jpg"    #此变量最好放正常图像的路径,标准图像
    abnorm_file=r"D:\adavance\Pyqt-main\DetectionModules\Algo1\Similarity_comparison_3D\test_data\daijian\clxz2.jpg" #此变量待检测图像路径，可以是正常的，也可以是异常的



    Sampling_interval=16 #点云降采样系数
    Sim_3D_dis_thresh=2
    result_box=sim.deform_detect_3D2(norm_file, abnorm_file,Sim_3D_dis_thresh, Sampling_interval)
    print(result_box)
